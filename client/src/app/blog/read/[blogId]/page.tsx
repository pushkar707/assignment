...
const Page = ({params}:any) => {
  ...
  if(blogDetails.title){
    return (
      <>
        <div className='bg-[#1188F0] py-16 w-full flex justify-center items-center flex-col text-white mt-5 px-1 lg:px-5' >
          <p className='text-2xl md:text-3xl mb-4 font-medium text-center'>{blogDetails.title}</p>
        ...
        <div className='p-10'>
          <img src={`https://${process.env.NEXT_PUBLIC_AWS_BUCKET_NAME}.s3.${process.env.NEXT_PUBLIC_AWS_BUCKET_REGION}.amazonaws.com/`+blogDetails.imageKey} className='block mb-8 mx-auto' />
